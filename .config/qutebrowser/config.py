...
config.bind(',ap', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/themes/apprentice.css ""')
config.bind(',dr', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/themes/dracula.css ""')
config.bind(',gr', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/themes/gruvbox.css ""')
config.bind(',sd', 'config-cycle content.user_stylesheets ~/.config/qutebrowser/themes/solarized-dark.css ""')
